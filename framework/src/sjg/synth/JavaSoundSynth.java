...
/**
 * Java Sound based synthesizer.
 * <p>
 * See http://www.musicdsp.org/archive.php?classid=3#92 for filter definitions.
 *
 * @author chvid
 */
            ...
            for (StringTokenizer st = new StringTokenizer(tune); st.hasMoreTokens(); ) {
                ...
                if (key.equals("f")) {
                    ...
                    if (keyIndex == -1) notes.add(new Note());
                        ...
                        notes.add(new Note(channel1, Math.pow(Math.pow(2, 1 / 12.0), keyIndex) * frequency, length, volume,
